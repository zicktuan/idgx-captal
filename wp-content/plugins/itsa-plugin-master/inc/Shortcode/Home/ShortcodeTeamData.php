<?php
    ...
    class ShortcodeTeamData extends AbstractShortcode
    {
        protected $parent;
        ...
        public function render($atts) {
            ...
            ob_start();
            include $this->parent->locateTemplate('home/shortcode-team.tpl.php');
            return ob_get_clean();
        }
        ...
        public function map() {
            ...
            return array(
                'name'        => esc_html__('Team Data', 'bookawesome'),
